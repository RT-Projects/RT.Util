...
/// <summary>
///     Provides extension methods on the <see cref="Process"/> type, as well as utility methods which are logically static
///     extensions on the Process type but have to be invoked as static methods of this class.</summary>
public static class ProcessExtensions
{
    ...
    /// <summary>
    ///     Returns a list of child processes of this process.</summary>
    /// <param name="process">
    ///     The process to return the children of.</param>
    /// <param name="recursive">
    ///     If true, all the children's children are included recursively. If false, only direct children are included.</param>
    ...
    /// <summary>
    ///     Kills this process and all children. Swallows all exceptions and does not wait for processes to die or check that
    ///     they died.</summary>
