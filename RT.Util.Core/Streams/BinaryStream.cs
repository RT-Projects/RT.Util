...
/// <summary>
///     Reads/writes various data types as binary values in a specific encoding.</summary>
/// <remarks>
///     <para>
...
public sealed class BinaryStream : Stream
{
    ...
    /// <summary>
    ///     Flushes the underlying stream. Note that <see cref="BinaryStream"/> does not use any buffering of its own that
    ///     requires flushing.</summary>
    ...
    /// <summary>
    ///     Sets the position within the underlying stream.</summary>
    /// <param name="offset">
    ///     A byte offset relative to the origin parameter.</param>
    /// <param name="origin">
    ///     A value indicating the reference point used.</param>
    /// <returns>
    ///     The new position within the underlying stream.</returns>
    public override long Seek(long offset, SeekOrigin origin) { return _stream.Seek(offset, origin); }
    /// <summary>
    ///     Sets the length of the underlying stream.</summary>
    /// <param name="value">
    ///     The desired length of the underlying stream in bytes.</param>
    ...
    ///     offset and (offset + count - 1) replaced by the bytes read from the underlying source.</param>
    /// <param name="offset">
    ///     The zero-based byte offset in buffer at which to begin storing the data read from the underlying stream.</param>
    /// <param name="count">
    ///     The maximum number of bytes to be read from the underlying stream.</param>
    /// <returns>
    ...
    /// <param name="offset">
    ///     The zero-based byte offset in buffer at which to begin copying bytes to the underlying stream.</param>
    /// <param name="count">
    ///     The number of bytes to be written to the underlying stream.</param>
    ...
    /// <summary>
    ///     Reads the specified number of bytes from the stream.</summary>
    /// <param name="count">
    ///     Number of bytes to read from the stream.</param>
    /// <returns>
    ///     A byte array containing exactly the number of bytes requested.</returns>
    /// <exception cref="EndOfStreamException">
    ///     The end of the stream was reached before the requested number of bytes could be read.</exception>
    ...
    /// <summary>
    ///     Writes the specified byte array into the stream.</summary>
    /// <param name="data">
    ///     Data to write to the stream.</param>
    ...
    /// <summary>
    ///     Reads a 32-bit signed integer using optim encoding (see <see cref="StreamExtensions.ReadInt32Optim"/>) from the
    ///     stream.</summary>
    ...
    /// <summary>
    ///     Writes a 32-bit signed integer using optim encoding (see <see cref="StreamExtensions.WriteInt32Optim"/>) to the
    ///     stream.</summary>
    ...
    /// <summary>
    ///     Reads a 32-bit unsigned integer using optim encoding (see <see cref="StreamExtensions.ReadUInt32Optim"/>) from the
    ///     stream.</summary>
    ...
    /// <summary>
    ///     Writes a 32-bit unsigned integer using optim encoding (see <see cref="StreamExtensions.WriteUInt32Optim"/>) to the
    ///     stream.</summary>
    ...
    /// <summary>
    ///     Reads a 64-bit signed integer using optim encoding (see <see cref="StreamExtensions.ReadInt64Optim"/>) from the
    ///     stream.</summary>
    ...
    /// <summary>
    ///     Writes a 64-bit signed integer using optim encoding (see <see cref="StreamExtensions.WriteInt64Optim"/>) to the
    ///     stream.</summary>
    ...
    /// <summary>
    ///     Reads a 64-bit unsigned integer using optim encoding (see <see cref="StreamExtensions.ReadUInt64Optim"/>) from the
    ///     stream.</summary>
    ...
    /// <summary>
    ///     Writes a 64-bit unsigned integer using optim encoding (see <see cref="StreamExtensions.WriteUInt64Optim"/>) to the
    ///     stream.</summary>
    ...
    /// <summary>
    ///     Writes the data contained in the specified <see cref="MemoryStream"/> to the stream as a length-prefixed block of
    ///     bytes.</summary>
    ...
    /// <summary>
    ///     Reads a length-prefixed block of bytes from the stream (for example, one produced by <see
    ///     cref="WriteMemoryStream"/>).</summary>
