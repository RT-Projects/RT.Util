...
/// <summary>
///     Provides a type descriptor which supports translation of various string values using the Lingo conventions (see
///     remarks).</summary>
/// <typeparam name="TTranslation">
///     The type of the translation class.</typeparam>
/// <remarks>
///     Every property requiring translatable name/description/category should have a corresponding method in the same class.
///     This method should be static, named the same as the property with a "Tr" suffix, take a translation instance and
///     return a <see cref="MemberTr"/>.</remarks>
public sealed class LingoTypeDescriptionProvider<TTranslation> : TypeDescriptionProvider where TTranslation : TranslationBase
{
    ...
    /// <summary>
    ///     Constructs a type description provider using the specified translation getter.</summary>
    /// <param name="getTranslation">
    ///     A function that returns the currently active translation.</param>
...
/// <summary>
///     Provides a base implementation for enum converters intended to enable enum translation. See remarks.</summary>
/// <typeparam name="TEnum">
///     Type of the enum being translated.</typeparam>
/// <typeparam name="TTranslation">
///     Type of a translation class which has fields named the same as enum values.</typeparam>
/// <remarks>
    ...
    where TEnum : struct
{
    ...
    ///     Constructor.</summary>
    /// <param name="getTranslation">
    ///     A method which returns the currently active translation for this enum.</param>
