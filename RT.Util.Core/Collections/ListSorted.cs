...
///     be added to the end of a run of equal items. Insertion, and removal are O(N); lookups are O(log N); access by index is
///     supported.</summary>
[Serializable]
public sealed class ListSorted<T> : IList<T>
{
    ...
    /// <summary>
    ///     Creates an empty <see cref="ListSorted&lt;T&gt;"/> of the specified capacity and using a default comparer for the
    ///     item type.</summary>
    ...
    /// <summary>
    ///     Adds all of the specified items into the list. The resulting list will contain all the items in the same order as
    ///     a stable sort would have produced. NOTE: the current implementation is O(N log N) if the collection is empty, or
    ///     O(N*M) otherwise, where N = items currently in the collection and M = items to be added. The latter can be
    ///     improved.</summary>
    ...
    /// <summary>
    ///     Returns the index of the FIRST item equal to the specified item, or -1 if the item is not found. The operation is
    ///     O(log N).</summary>
    ...
    /// <summary>
    ///     Returns the index of the LAST item equal to the specified item, or -1 if the item is not found. The operation is
    ///     O(log N).</summary>
    ...
    ///     multiple equal items are stored, this method is guaranteed to add an item at the end of the equal items run. This
    ///     method is O(N).</summary>
    ...
    /// <summary>
    ///     Removes the FIRST occurrence of the specified item from the list. Returns true if the item was removed, or false
    ///     if it wasn't found.</summary>
    ...
    /// <summary>
    ///     Removes the LAST occurrence of the specified item from the list. Returns true if the item was removed, or false if
    ///     it wasn't found.</summary>
