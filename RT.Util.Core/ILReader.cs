...
static class ILReader
{
    ...
    /// <summary>
    ///     Decodes the IL inside the specified method.</summary>
    /// <param name="method">
    ///     The method whose IL to decode. This may be a constructor, too.</param>
    /// <param name="genericContext">
    ///     The type in which the method is declared, to provide context to resolve members that involve generics.</param>
    /// <returns>
    ///     The sequence of <see cref="Instruction"/> instances describing the instructions in the method.</returns>
