...
public sealed class TranslationCreateForm : Form
{
    ...
    /// <summary>
    ///     Presents the user with a dialog to select a language from, and (if they click "OK") creates a new XML file for the
    ///     new translation.</summary>
    /// <typeparam name="TTranslation">
    ///     Class containing the translatable strings.</typeparam>
    /// <param name="moduleName">
    ///     Name of the module being translated (forms part of the translation's XML file).</param>
    /// <param name="fontName">
    ///     Specifies the name of the font to use in this dialog, or null for the default font.</param>
    /// <param name="fontSize">
    ///     Specifies the size of the font to use in this dialog. Ignored if <paramref name="fontName"/> is null.</param>
    /// <returns>
    ///     If the user clicked OK, creates a new XML file and returns the translation. If the user clicked Cancel, returns
    ///     null.</returns>
