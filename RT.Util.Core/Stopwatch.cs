...
/// <summary>Encapsulates a single entry in a <see cref="Stopwatch"/> log.</summary>
...
/// <summary>
///     Abstract base class to encapsulate a stopwatch - an object that remembers events as they happen and when they happen
///     and outputs a report with timing information at the end.</summary>
public abstract class Stopwatch
{
    ...
    /// <param name="msg">
    ///     Message to log.</param>
    public abstract void Log(string msg);

    /// <summary>
    ///     Outputs the stopwatch report with timing information to the specified file.</summary>
    /// <param name="filePath">
    ///     File to save stopwatch output to. If the file already exists, it will be overwritten.</param>
    public abstract void SaveToFile(string filePath);
}

/// <summary>
///     Concrete implementation of <see cref="Stopwatch"/>. This class provides an object that remembers events as they happen
///     and when they happen and outputs a report with timing information at the end.</summary>
public sealed class StopwatchReal : Stopwatch
{
    /// <summary>Remembers when the stopwatch was started.</summary>
    ...
    /// <summary>
    ///     Generates a report with timing information detailling when each logged event happened relative to the <see
    ///     cref="StartTime"/>.</summary>
    /// <returns>
    ///     A report with timing information detailling when each logged event happened relative to the <see
    ///     cref="StartTime"/>.</returns>
...
/// <summary>Implementation of <see cref="Stopwatch"/> that logs messages to the console.</summary>
...
/// <summary>Implementation of <see cref="Stopwatch"/> that doesn't do anything.</summary>
public sealed class StopwatchDummy : Stopwatch
{
    /// <summary>
    ///     Doesn't do anything.</summary>
    /// <param name="msg">
    ///     Is ignored.</param>
    public override void Log(string msg) { }
