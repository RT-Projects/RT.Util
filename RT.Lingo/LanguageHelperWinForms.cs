...
/// <summary>
///     Helps an application using Lingo to display language selection UI using WinForms controls.</summary>
...
public class LanguageHelperWinForms<TTranslation> : LanguageHelper<TTranslation> where TTranslation : TranslationBase, new()
{
    ...
    /// <param name="settings">
    ///     Translation window settings, such as window position/size.</param>
    /// <param name="icon">
    ///     The icon to use on the translation window.</param>
    ...
    /// <summary>
    ///     Displays a context menu listing all available languages, and optionally controls to edit the translations.</summary>
    /// <param name="positionControl">
    ///     The menu's position is specified relative to this control.</param>
    /// <param name="position">
    ///     The menu's desired position relative to <paramref name="positionControl"/>.</param>
    ...
    /// <summary>
    ///     Initialises the combo box to list all available languages and change the application translation when one gets
    ///     selected.</summary>
    /// <remarks>
    ///     Do not call multiple times for the same combo box.</remarks>
    ...
    /// <summary>
    ///     Initialises the menu item to provide language selection UI and any translation editing UI.</summary>
    /// <remarks>
    ///     Do not call multiple times for the same combo box.</remarks>
