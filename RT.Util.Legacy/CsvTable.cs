...
/// <summary>Holds a table of RVariant values, which can be saved to a file in CSV format.</summary>
public sealed class CsvTable
{
    ...
    /// <summary>Determines whether adding a cell moves the cursor to the right or down.</summary>
    public bool AdvanceRight = true;

    /// <summary>Adds a value at the current location and advances the cursor.</summary>
    ...
    /// <summary>Advances the cursor down or to the right, depending on the value of <see cref="AdvanceRight"/>.</summary>
    ...
    /// <summary>Moves cursor to the specified position.</summary>
    ...
    /// <summary>
    ///     Gets/sets the value at the specified position. Returns a "blank" (stub) <see cref="RVariant"/> if the value hasn't
    ///     been set yet.</summary>
    ...
    /// <summary>Saves the table to a file in Excel-compatible CSV format.</summary>
