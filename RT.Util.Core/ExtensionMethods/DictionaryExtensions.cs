...
/// <summary>
///     Provides extension methods on dictionaries (<see cref="Dictionary{TKey, TValue}"/> and <see cref="IDictionary{TKey,
///     TValue}"/>).</summary>
#if EXPORT_UTIL
public
#endif
static class DictionaryExtensions
{
    ...
    /// <summary>
    ///     Gets a value from a two-level dictionary by key. If the keys don’t exist in the dictionary, the default value is
