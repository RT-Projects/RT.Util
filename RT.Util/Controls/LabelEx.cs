...
/// <summary>
///     Implements a label control that supports basic formatting of the displayed text. Text alignment and right-to-left text
///     are not supported.</summary>
public class LabelEx : Control, IButtonControl
{
    /// <summary>
    ///     Contains values that specify the unit in which the value of the <see cref="HangingIndent"/> property is measured.</summary>
    ...
    /// <summary>
    ///     Text displayed in the label. See remarks for EggsML supported. Setting this property also changes the value of the
    ///     <see cref="TabStop"/> property depending on whether the text contains any links. To achieve deviant behaviour, set
    ///     TabStop immediately after setting Text.</summary>
    /// <remarks>
    ///     <list type="bullet">
    ///         <item><description>
    ///             <c>*</c> = bold.</description></item>
    ///         <item><description>
    ///             <c>/</c> = italics.</description></item>
    ///         <item><description>
    ///             <c>_</c> = underline.</description></item>
    ///         <item><description>
    ///             <c>+</c> = marks a section of text as nowrap.</description></item>
    ///         <item><description>
    ///             <c>&lt;XYZ&gt;{ ... }</c> = make the text enclosed in curlies a link. XYZ can be any string and will be
    ///             passed in for the <see cref="LinkActivated"/> event.</description></item>
    ///         <item><description>
    ///             <c>&lt;XYZ&gt;= ... =</c> = colour the text enclosed in equals sign in the colour designated by XYZ (e.g.
    ///             “Red”).</description></item>
    ///         <item><description>
    ///             <c>[ ... ]</c> = adds a bullet point to the beginning of a paragraph. (Enclose the entire paragraph
    ///             without its trailing newline, otherwise behaviour is weird.)</description></item></list></remarks>
    ...
    /// <summary>
    ///     Specifies an amount by which all but the first line of each paragraph are indented.</summary>
    ...
    /// <summary>
    ///     Contains information about a parse error that describes in what way the current value of <see cref="Text"/> is
    ///     invalid EggsML, or null if it is valid.</summary>
...
/// <summary>
///     Represents the method that will handle the <see cref="LabelEx.LinkActivated"/> event.</summary>
/// <param name="sender">
///     The source of the event.</param>
/// <param name="e">
///     A <see cref="LinkEventArgs"/> that contains the event data.</param>
