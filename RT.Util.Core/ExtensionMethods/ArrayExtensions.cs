...
{
    /// <summary>
    ///     Similar to <see cref="string.Substring(int)"/>, but for arrays. Returns a new array containing all items from the
    ...
    /// <summary>
    ///     Similar to <see cref="string.Remove(int)"/>, but for arrays. Returns a new array containing only the items before
    ///     the specified <paramref name="startIndex"/>.</summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Similar to <see cref="string.Insert(int, string)"/>, but for arrays and for a single value. Returns a new array
    ///     with the <paramref name="value"/> inserted at the specified <paramref name="startIndex"/>.</summary>
    ...
    ///     can be returned is this minus the length of <paramref name="findWhat"/> plus <paramref name="startIndex"/>.</param>
    /// <param name="comparer">
    ///     Optional equality comparer.</param>
    /// <returns>
    ///     The index of the first match, or -1 if no match is found.</returns>
