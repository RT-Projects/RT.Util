...
namespace RT.Util.Lingo
{
    ...
    [AttributeUsage(AttributeTargets.Field, Inherited = true, AllowMultiple = false), RummageKeepUsersReflectionSafe]
    ...
    [Conditional("DEBUG"), AttributeUsage(AttributeTargets.Field, Inherited = false, AllowMultiple = false), RummageKeepUsersReflectionSafe]
