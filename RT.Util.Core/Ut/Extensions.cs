...
{
    /// <summary>
    ///     Returns null if the input is null, otherwise the result of the specified lambda when applied to the input.</summary>
    /// <typeparam name="TInput">
    ///     Type of the input value.</typeparam>
    /// <typeparam name="TResult">
    ///     Type of the result from the lambda.</typeparam>
    /// <param name="input">
    ///     Input value to check for null.</param>
    /// <param name="lambda">
    ///     Function to apply the input value to if it is not null.</param>
