...
/// <summary>
///     <para>
///         Provides functionality similar to <see cref="System.Convert"/>, but ensures that all conversions are lossless and
///         roundtrippable. Whenever a conversion cannot be performed exactly, an <see cref="ExactConvertException"/> is
///         thrown.</para></summary>
/// <remarks>
///     <code>
///         SUPPORTED TYPES
...
static class ExactConvert
{
    ...
    /// <summary>
    ///     Initialises the internally-used lookup tables for determining what kind of type is being dealt with (e.g. is this
    ///     an unsigned type?)</summary>
    static ExactConvert()
    {
        int max = 0;
    ...
    /// <summary>
    ///     Returns true if the specified type is one of the 8 built-in "true" integer types: the signed and unsigned 8, 16,
    ///     32 and 64-bit types.</summary>
    /// <param name="type">
    ...
    ///     and unsigned 8, 16, 32 and 64-bit types.</summary>
    /// <param name="type">
    ///     The type to be tested.</param>
    ...
    /// <summary>
    ///     Returns true if the specified type is integer-compatible (in other words, a string of digits can be converted to
    ///     it using <see cref="ExactConvert"/>). This includes all types that are <see cref="IsTrueIntegerType(Type)"/> as
    ///     well as DateTime, Char and Boolean.</summary>
    /// <param name="type">
    ///     The type to be tested.</param>
    ...
    /// <summary>
    ///     C# does not allow a boxed integer type to be unboxed as anything other than the true type of the boxed integer.
    ///     This utility function unboxes the integer as the correct type and then casts it to a long, returning the result.
    ///     Throws an exception if the object is null or not one of the built-in integer types. Does not support unboxing of a
    ///     ulong because the cast to long would be lossy and misleading. Will throw an exception when given a boxed ulong.</summary>
    ...
    ///     make sense... but really, I think this is how it really should have been since it is a lot more useful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a byte. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a ushort. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a uint. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a ulong. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to an sbyte. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a short. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to an int. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a long. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    ///     converted exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a bool. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful. If the
    ///     value is one of the integer types, the exact conversion only succeeds if the value is in range, i.e. 0 or 1. If
    ///     converting from a string, the string must be exactly (case-insensitive) equal to "True" or "False", or the
    ///     conversion will fail.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a char. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    ///     converted exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.
    ///     When converting from string, supports a subset of the ISO 8601 formats - for more details see <see
    ///     cref="DateTimeExtensions.TryParseIso"/>.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a float. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a double. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a decimal. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a string. Returns true if successful, or false if the object cannot be converted
    ///     exactly. <paramref name="result"/> is set to the type's default value if the conversion is unsuccessful, which in
    ///     this case means null (!!!). Note that the result will only ever be false if the value is one of the unsupported
    ///     types - all supported types can be converted to a string. (So can the unsupported ones but it's a different
    ///     matter. Unsupported types are not supported by this method for consistency with the other overloads.)</summary>
    ...
    /// <summary>
    ///     Converts the specified object to the type <paramref name="toType"/>. Returns true if successful, or false if the
    ///     object cannot be converted exactly. <paramref name="result"/> is set to null if the conversion is unsuccessful.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to an sbyte. Throws an <see cref="ExactConvertException"/> if the object cannot be
    ///     converted exactly.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a short. Throws an <see cref="ExactConvertException"/> if the object cannot be
    ///     converted exactly.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a ushort. Throws an <see cref="ExactConvertException"/> if the object cannot be
    ///     converted exactly.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a ulong. Throws an <see cref="ExactConvertException"/> if the object cannot be
    ///     converted exactly.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a float. Throws an <see cref="ExactConvertException"/> if the object cannot be
    ///     converted exactly.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a double. Throws an <see cref="ExactConvertException"/> if the object cannot be
    ///     converted exactly.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a decimal. Throws an <see cref="ExactConvertException"/> if the object cannot be
    ///     converted exactly.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a DateTime. Throws an <see cref="ExactConvertException"/> if the object cannot be
    ///     converted exactly.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a string. Throws an <see cref="ExactConvertException"/> if the object cannot be
    ///     converted exactly.</summary>
    ...
    /// <summary>
    ///     Converts the specified object to a BigInteger. Throws an <see cref="ExactConvertException"/> if the object cannot
    ...
    /// <summary>
    ///     Converts the value to type <paramref name="toType"/>. Throws an <see cref="ExactConvertException"/> if the object
    ...
    /// <summary>
    ///     Converts the value to type <typeparamref name="T"/>. Throws an <see cref="ExactConvertException"/> if the object
    ///     cannot be converted exactly.</summary>
    ...
    /// <summary>
    ///     Contains static methods to perform an exact conversion to a nullable type. These methods return null only if the
    ///     input is null. A failed conversion results in an <see cref="ExactConvertException"/>.</summary>
    public static class ToNullable
    {
        /// <summary>
        ///     Converts the specified object to a nullable bool. Returns null if <paramref name="value"/> is null. Throws an
        ///     <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static bool? Bool(object value) => value == null ? null : (bool?) ToBool(value);

        /// <summary>
        ///     Converts the specified object to a nullable byte. Returns null if <paramref name="value"/> is null. Throws an
        ///     <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static byte? Byte(object value) => value == null ? null : (byte?) ToByte(value);

        /// <summary>
        ///     Converts the specified object to an nullable sbyte. Returns null if <paramref name="value"/> is null. Throws
        ...
        /// <summary>
        ///     Converts the specified object to a nullable short. Returns null if <paramref name="value"/> is null. Throws an
        ///     <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static short? Short(object value) => value == null ? null : (short?) ToShort(value);

        /// <summary>
        ///     Converts the specified object to a nullable ushort. Returns null if <paramref name="value"/> is null. Throws
        ///     an <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static ushort? UShort(object value) => value == null ? null : (ushort?) ToUShort(value);

        /// <summary>
        ///     Converts the specified object to an nullable int. Returns null if <paramref name="value"/> is null. Throws an
        ///     <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static int? Int(object value) => value == null ? null : (int?) ToInt(value);

        /// <summary>
        ///     Converts the specified object to a nullable uint. Returns null if <paramref name="value"/> is null. Throws an
        ///     <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static uint? UInt(object value) => value == null ? null : (uint?) ToUInt(value);

        /// <summary>
        ///     Converts the specified object to a nullable long. Returns null if <paramref name="value"/> is null. Throws an
        ///     <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static long? Long(object value) => value == null ? null : (long?) ToLong(value);

        /// <summary>
        ///     Converts the specified object to a nullable ulong. Returns null if <paramref name="value"/> is null. Throws an
        ///     <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        ...
        /// <summary>
        ///     Converts the specified object to a nullable float. Returns null if <paramref name="value"/> is null. Throws an
        ///     <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static float? Float(object value) => value == null ? null : (float?) ToFloat(value);

        /// <summary>
        ///     Converts the specified object to a nullable double. Returns null if <paramref name="value"/> is null. Throws
        ///     an <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static double? Double(object value) => value == null ? null : (double?) ToDouble(value);

        /// <summary>
        ///     Converts the specified object to a nullable decimal. Returns null if <paramref name="value"/> is null. Throws
        ///     an <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static decimal? Decimal(object value) => value == null ? null : (decimal?) ToDecimal(value);

        /// <summary>
        ///     Converts the specified object to a nullable DateTime. Returns null if <paramref name="value"/> is null. Throws
        ///     an <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static DateTime? DateTime(object value) => value == null ? null : (DateTime?) ToDateTime(value);

        /// <summary>
        ///     Converts the specified object to a nullable char. Returns null if <paramref name="value"/> is null. Throws an
        ///     <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
        public static char? Char(object value) => value == null ? null : (char?) ToChar(value);

        /// <summary>
        ///     Converts the specified object to a nullable string. Returns null if <paramref name="value"/> is null. Throws
        ///     an <see cref="ExactConvertException"/> if the object cannot be converted exactly.</summary>
