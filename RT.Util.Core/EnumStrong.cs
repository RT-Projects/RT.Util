...
{
    /// <summary>
    ///     Returns the enum value corresponding to the specified string.</summary>
    /// <typeparam name="T">
    ///     The enum type from which to retrieve the value.</typeparam>
    /// <param name="value">
    ///     The string value for which to return the corresponding enum value.</param>
    ...
    ///     A string containing the name or value to convert.</param>
    /// <param name="result">
    ///     Variable receiving the converted value.</param>
    /// <returns>
    ///     True if the value was successfully converted; false otherwise.</returns>
