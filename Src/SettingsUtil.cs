...
namespace RT.Util
{
    ...
    public static class SettingsUtil
    {
        ...
        /// <param name="plain">Plaintext password to encrypt.</param>
        /// <param name="key">The key to use for encryption. Must be exactly 32 bytes long.</param>
        ...
        /// <summary>Decrypts a password encrypted with <see cref="EncryptPassword"/>.</summary>
        /// <param name="cipher">The output of <see cref="EncryptPassword"/>.</param>
