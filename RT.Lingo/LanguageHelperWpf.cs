...
/// <summary>
///     Helps an application using Lingo to display language selection UI using WPF controls.</summary>
...
public class LanguageHelperWpf<TTranslation> : LanguageHelper<TTranslation> where TTranslation : TranslationBase, new()
{
    ...
    /// <summary>
    ///     Appends menu items for changing languages and, optionally, translation editing. The menu items are hooked with
    ///     appropriate click handlers.</summary>
...
/// <summary>
///     Helps an application using Lingo to display language selection UI using WPF controls but the WinForms translation UI.</summary>
/// <remarks>
///     This class is required for as long as the WPF translation UI is unfinished.</remarks>
/// <typeparam name="TTranslation">
///     The type of the class holding the program’s translation.</typeparam>
