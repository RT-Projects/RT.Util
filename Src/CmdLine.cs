...
namespace RT.Util.CommandLine
{
    ...
    ///                     field can be positional (<see cref="IsPositionalAttribute"/>) or not (<see
    ///                     cref="OptionAttribute"/>).</description></item>
    ///                 <item><description>
    ///                     <c>string[]</c>. The field can be positional (<see cref="IsPositionalAttribute"/>) or not (<see
    ///                     cref="OptionAttribute"/>), but if it is positional, it must be the last field in the
    ...
    ///                     have at least two derived classes, each with a <see
    ///                     cref="CommandNameAttribute"/>.</description></item>
    ///                 <item><description>
    ///                     <para>
    ...
    ///                             cref="CommandNameAttribute"/> to specify the name by which that enum value is
    ...
    ///                                 cref="OptionAttribute"/> to specify the option by which that enum value is
    ///                                 selected:</para>
    ///                             <code>
    ///                                 enum OutputFormat
    ///                                 {
    ...
    ///                                 enum value or multiple (which will be combined using bitwise
    ///                                 or).</para></description></item>
    ///                         <item><description>
    ///                             If the field is optional, the enum value that corresponds to the field’s initial (default)
    ///                             value may omit the <see cref="CommandNameAttribute"/> or <see
    ///                             cref="OptionAttribute"/>.</description></item></list></description></item></list></description></item>
    ///         <item><description>
    ///             <para>
    ...
    ///                         followed by <c>Doc</c>. The return value is the translated
    ///                         string.</para></description></item></list></description></item>
    ///         <item><description>
...
#pragma warning restore 1591    // Missing XML comment for publicly visible type or member
    ...
    ///     cref="OptionAttribute"/> or <see cref="CommandNameAttribute"/> attribute with a matching option or command
    ///     name).</summary>
    [Serializable]
