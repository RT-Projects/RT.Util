...
/// <summary>Provides extension methods on the collection type.</summary>
public static class IQueryableExtensions
{
    ...
    /// <summary>
    ///     Returns an enumeration of <see cref="Tuple&lt;T, U&gt;"/>s containing all ordered pairs of elements from the two
    ///     source collections. For example, [1, 2].Join(["one", "two"]) results in the tuples [1, "one"], [1, "two"], [2,
    ///     "one"] and [2, "two"].</summary>
    ...
    /// <remarks>
    ///     Warning: This method does not work with IQToolkit.</remarks>
    ...
    /// <summary>Returns an enumeration of the specified enumerable in sorted order.</summary>
    ...
    /// <summary>
    ///     Adds a single element to the end of an IQueryable.</summary>
    /// <typeparam name="T">
    ///     Type of enumerable to return.</typeparam>
    /// <returns>
    ///     IQueryable containing all the input elements, followed by the specified additional element.</returns>
    ...
    /// <param name="source">
    ///     The collection to return the first element of.</param>
    /// <param name="default">
