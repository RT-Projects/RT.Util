...
public static partial class Ut
{
    ...
    ///     The code to be executed.</param>
    /// <returns>
    ///     True if <paramref name="action"/> returned without exceptions, false if <typeparamref name="TException"/> was
    ///     caught and suppressed.</returns>
    ...
    ///     Delay, in milliseconds, before retrying <paramref name="action"/>.</param>
    /// <returns>
    ///     True if <paramref name="action"/> returned without exceptions, false if an exception was caught and suppressed on
    ...
    /// <returns>
    ///     True if <paramref name="action"/> returned without exceptions, false if <typeparamref name="TException"/> was
    ///     caught and suppressed on every attempt.</returns>
    ...
    /// <summary>
    ///     Evaluates the specified code and returns its result. If the code throws any exceptions, retries the specified
    ///     number of times. If the code still throws on the final attempt, returns <paramref name="default"/> instead.</summary>
    /// <param name="func">
    ///     The code to be executed.</param>
    /// <param name="default">
    ///     Value to return in case of failure.</param>
