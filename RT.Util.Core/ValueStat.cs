...
///     underlying distribution available at every point.</summary>
public class ValueStat
{
    ...
    /// <summary>
    ///     Adds a number of observations, updating all statistics as appropriate. The nature of the statistics collected by
    ///     the class enable this operation by only having similar statistics about the observations being added.</summary>
    /// <param name="count">
    ///     Number of observations added.</param>
    /// <param name="mean">
    ///     The sample mean of the added observations.</param>
    /// <param name="min">
    ///     The minimum of the added observations.</param>
    /// <param name="max">
    ///     The maximum of the added observations.</param>
    /// <param name="variance">
    ///     The sample variance of the added observations.</param>
