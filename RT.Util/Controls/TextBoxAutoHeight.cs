...
/// <summary>
///     Encapsulates a textbox which, when in multi-line and wordwrap mode, will automatically set its height to be precisely
///     as necessary to accommodate the contained text.</summary>
public sealed class TextBoxAutoHeight : TextBoxEx
{
    ...
    /// <summary>
    ///     Overrides the base class's WndProc message to capture mouse-wheel messages and pass them on to the GUI parent
    ///     instead.</summary>
    /// <param name="m">
    ///     A Windows Message object.</param>
    ...
    /// <summary>
    ///     Raises the <see cref="System.Windows.Forms.Control.SizeChanged"/> event.</summary>
    /// <param name="e"/>
