...
///     interval on every chunk.</summary>
public sealed class SlowStream : Stream
{
    ...
    ///     which means no delay.</summary>
    public int SleepInterval { get; set; }

    private Stream _stream;

    /// <summary>
    ///     Initialises a new SlowStream instance.</summary>
    /// <param name="stream">
    ///     The underlying stream to read in chunks from.</param>
    /// <param name="chunkSize">
    ///     The number of bytes to read per chunk. Defaults to 1 KB.</param>
...
#pragma warning restore 1591    // Missing XML comment for publicly visible type or member
    ...
    /// <summary>
    ///     Reads at most <see cref="ChunkSize"/> bytes from the underlying stream.</summary>
    /// <param name="buffer">
    ///     Buffer to store results into.</param>
    /// <param name="offset">
    ///     Offset in buffer to store results at.</param>
    /// <param name="count">
    ///     Maximum number of bytes to read.</param>
    /// <returns>
