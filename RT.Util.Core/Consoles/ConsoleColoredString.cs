...
///             cref="ConsoleUtil.WriteLine(ConsoleColoredString,bool,RT.Util.Text.HorizontalTextAlignment)"/> to output the
///             string to the console.</description></item>
///         <item><description>
...
public sealed class ConsoleColoredString : IEnumerable<ConsoleColoredChar>, IEquatable<ConsoleColoredString>
{
    ...
    ///     character.</summary>
    /// <param name="input">
    ///     The string containing the text to initialize this <see cref="ConsoleColoredString"/> to. The length of this string
    ///     must match the number of elements in <paramref name="foregroundColors"/>.</param>
    /// <param name="foregroundColors">
    ///     The foreground colors to assign to each character in the string. The length of this array must match the number of
    ///     characters in <paramref name="input"/>.</param>
    /// <param name="backgroundColors">
    ///     The background colors to assign to each character in the string. The length of this array must match the number of
    ///     characters in <paramref name="input"/>. If <c>null</c>, the default color is used.</param>
    ...
    /// <summary>
    ///     Constructs a <see cref="ConsoleColoredString"/> by concatenating the specified <see cref="ConsoleColoredChar"/>s.</summary>
    ...
    ///     Second input string to concatenate.</param>
    /// <remarks>
    ///     The color of each character in the first input string is preserved. The second input string is given the console
    ///     default color.</remarks>
    ...
    ///     Second input string to concatenate.</param>
    /// <remarks>
    ///     The color of each character in the second input string is preserved. The first input string is given the console
    ///     default color.</remarks>
    ...
    ///     returned, or <see cref="System.StringSplitOptions.None"/> to include empty array elements in the array returned.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Changes the foreground colors (but not the background colors) of every occurrence of <paramref name="character"/>
    ///     in the current string to the specified console color.</summary>
    ...
    /// <summary>
    ///     Changes the colors of every occurrence of <paramref name="character"/> in the current string to the specified set
    ///     of console colors.</summary>
    /// <param name="character">
    ///     The character whose color to replace.</param>
    /// <param name="foreground">
    ///     The foreground color to set the characters to, or <c>null</c> to use the console’s default foreground color.</param>
    ...
    /// <summary>
    ///     Changes the colors of every character in the current string to the specified console color only where there isn’t
    ///     already a color defined.</summary>
    /// <param name="foreground">
    ///     The foreground color to set the uncolored characters to, or <c>null</c> to use the console’s default foreground
    ///     color.</param>
    /// <param name="background">
    ///     The background color to set the uncolored characters to, or <c>null</c> to use the console’s default background
    ///     color.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Changes the background colors of every character in the current string to the specified console color only where
    ///     there isn’t already a background color defined.</summary>
    /// <param name="background">
    ///     The background color to set the uncolored characters to, or <c>null</c> to use the console’s default background
    ///     color.</param>
    /// <returns>
    ...
    /// <param name="foreground">
    ///     The foreground color to assign to the range of characters, or <c>null</c> to use the console’s default foreground
    ///     color.</param>
    /// <returns>
    ...
    ///     color.</param>
    /// <param name="background">
    ///     The background color to assign to the range of characters, or <c>null</c> to use the console’s default background
    ///     color.</param>
    /// <returns>
    ...
    ///     for a specified total length.</summary>
...
public struct ConsoleColoredChar
{
    ...
    /// <summary>
    ///     Concatenates a string onto a <see cref="ConsoleColoredChar"/> and returns a <see cref="ConsoleColoredString"/>.</summary>
    /// <param name="string1">
    ///     First input string to concatenate.</param>
    /// <param name="char2">
    ///     Second input character to concatenate.</param>
