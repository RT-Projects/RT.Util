...
static class IEnumerableExtensions
{
    ...
    ///     once, and in a lazy fashion. Also, enumerating the first item will take longer than enumerating subsequent items.</summary>
    /// <param name="source">
    ...
    ///     optional key comparers.</summary>
    /// <typeparam name="TSource">
    ///     The type of the elements of <paramref name="source"/>.</typeparam>
    ...
    /// <returns>
    ///     Of all elements that occur the most number of times, the one whose last instance occurs soonest in the sequence.</returns>
    ...
    /// <summary>
    ///     Returns only the non-<c>null</c> elements from the specified collection of nullable values as non-nullable values.</summary>
    /// <typeparam name="T">
    ...
    /// <returns>
    ///     <c>true</c> if every element of the source sequence passes the test in the specified <paramref name="predicate"/>,
    ...
    ///     source element.</param>
    /// <returns>
    ///     <c>true</c> if any elements in the source sequence pass the test in the specified <paramref name="predicate"/>;
    ...
    ///     If <c>true</c>, duplicate keys are ignored and only their first occurrence added to the dictionary. Otherwise, a
    ///     duplicate key causes an exception.</param>
