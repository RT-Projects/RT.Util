...
/// <summary>This class is used by the <see cref="DlgMessage"/> class. This is the form used for displaying the message box.</summary>
internal sealed partial class DlgMessageForm : Form
{
    ...
    /// <summary>
    ///     This takes care of the user closing the dialog. This is equivalent to pressing the Cancel button, whichever one it
...
/// <summary>
///     Holds a number of settings that define a message dialog. Provides a method to show the dialog represented, as well as
///     static methods to show some common dialog kinds with most settings at their defaults.</summary>
public sealed class DlgMessage
{
    /// <summary>
    ///     Specifies the message type. This selects a sound, an image and a caption to be used by default, unless explicitly
    ///     overridden in the other fields of this class. Defaults to <see cref="DlgType.Info"/>.</summary>
    public DlgType Type = DlgType.Info;
    /// <summary>
    ///     Specifies the labels of the buttons to be displayed in the dialog. Defaults to null, in which case a single "OK"
    ///     button will appear. May contain at most four elements. The labels may include the ampersand to indicate a shortcut
    ///     key, or double-ampersand to include an ampersand.</summary>
    public string[] Buttons;
    /// <summary>
    ///     Specifies the message to be displayed in the main message area. Defaults to null, in which case the message area
    ...
    /// <summary>
    ///     Specifies a caption to be displayed in the dialog's window title bar. Defaults to null, which means choose a title
    ///     based on the <see cref="Type"/> field.</summary>
    ...
    /// <summary>
    ///     Specifies a font to be used for the message text (but not the buttons). Defaults to null, which means the default
    ///     system font should be used.</summary>
    public Font Font;       // null acceptable as final value
    /// <summary>
    ///     Specifies the index of the accept button (the one selected if the user just presses Enter). Defaults to -1, which
    ///     means the button with index 0.</summary>
    public int AcceptButton = -1;
    /// <summary>
    ///     Specifies the index of the cancel button (the one selected if the user just presses Esc or Alt+F4). Defaults to
    ///     -1, which means the button with the largest valid index.</summary>
    ...
    /// <summary>
    ///     Creates a message form and fills in the controls using the current settings. Does not verify whether the settings
    ///     are valid, so must only be used internally and only after the settings have been verified.</summary>
    /// <returns>
