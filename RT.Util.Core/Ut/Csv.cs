...
namespace RT.Util
{
    public static partial class Ut
    {
        ...
        ///     The minimum number of columns to return for each row. Any row with fewer columns than this is padded with
        ///     empty string values to meet this minimum.</param>
        /// <returns>
        ...
        /// <summary>
        ///     Parses the file at <paramref name="path"/> as CSV. For details see <see cref="ParseCsv(TextReader, int)"/>.</summary>
