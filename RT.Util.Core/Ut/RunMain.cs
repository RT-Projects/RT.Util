...
static partial class Ut
{
    ...
    ///     exceptions are caught, including those on other threads, and passed on to the specified handlers. Also, the main
    ///     thread is given the name "Main".</summary>
    /// <param name="main">
    ...
    ///     Method called in case a thread other than the one executing the main method throws an unhandled exception. If
    ///     null, <paramref name="onUnhandledMain"/> will be called instead.</param>
    ...
    ///     A method which executes the core of the application.</param>
    /// <param name="onUnhandledMain">
    ///     Method called in case the main method throws an unhandled exception. The return value is what this method will
    ///     return.</param>
    /// <param name="onUnhandledThread">
    ///     Method called in case a thread other than the one executing the main method throws an unhandled exception. If
    ///     null, <paramref name="onUnhandledMain"/> will be called instead, and its return value will be ignored.</param>
