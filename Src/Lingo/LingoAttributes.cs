...
#if DEBUG
    /// <summary>This attribute is automatically added by <see cref="Lingo.TranslateControl(System.Windows.Forms.Control, object, string)"/> to indicate automatically-generated string classes.</summary>
    [AttributeUsage(AttributeTargets.Class, Inherited = false, AllowMultiple = false)]
