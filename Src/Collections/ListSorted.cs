...
{
    /// <summary>
    /// Implements a list whose items are always stored in a sorted order. Multiple equal
    ...
    public class ListSorted<T> : IList<T>
    {
        ...
        /// <summary>
        /// Creates an empty <see cref="ListSorted&lt;T&gt;"/> using a default comparer for the item type.
        /// </summary>
        public ListSorted()
        {
            _list = new List<T>();
        ...
        /// <summary>
        /// Creates an empty <see cref="ListSorted&lt;T&gt;"/> of the specified capacity and using a default
        ...
        /// <summary>
        /// Creates an empty <see cref="ListSorted&lt;T&gt;"/> using the specified item comparer.
        /// </summary>
        ...
        /// <summary>
        /// Creates an empty <see cref="ListSorted&lt;T&gt;"/> of the specified capacity and using the
        ...
        /// <summary>
        /// Adds all of the specified items into the list. The resulting list will contain
        /// all the items in the same order as a stable sort would have produced.
        /// 
        /// NOTE: the current implementation is O(N log N) if the collection is empty, or
        /// O(N*M) otherwise, where N = items currently in the collection and M = items to be added.
        ...
        /// <summary>
        /// Returns the index of the FIRST item equal to the specified item, or -1 if the item is not found.
        ...
        /// <summary>
        /// Returns the index of the LAST item equal to the specified item, or -1 if the item is not found.
        /// The operation is O(log N).
        /// </summary>
        ...
        /// <summary>
        /// Not supported in this class, will always throw an exception.
        /// </summary>
        ...
        /// <summary>
        /// Adds the specified item to the list. The item is added at the appropriate location to keep the
        /// list sorted. If multiple equal items are stored, this method is guaranteed to add an item at the
        /// end of the equal items run. This method is O(N).
        /// </summary>
        ...
        /// <summary>
        /// Copies all items of this collection into the specified array, starting at the specified
        ...
        /// Returns true if the item was removed, or false if it wasn't found.
        /// </summary>
