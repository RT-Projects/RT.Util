...
public static class SettingsUtil
{
    ...
    ///     cref="PostBuildChecker.RunPostBuildChecks"/>. This method is available only in DEBUG mode.</summary>
    /// <typeparam name="TSettings">
    ...
    /// <summary>
    ///     Loads settings into the specified class, or, if not available, creates a new instance of the class. See Remarks.</summary>
    /// <remarks>
...
#pragma warning restore SYSLIB0006
    ...
    /// <summary>
    ///     Gets the <see cref="SettingsAttribute"/> instance specified on this settings class, or null if none are specified.</summary>
...
public abstract class SettingsThreadedBase : SettingsBase
{
    ...
    ///         cref="SettingsBase.Save"/> when you want to guarantee a save, especially just before the program terminates.</para></summary>
...
public enum SettingsKind
{
    ...
    ///     user accounts, and do not roam. In portable mode: always shared; user account and machine name do not matter.</summary>
    Global,
}
...
public sealed class SettingsAttribute : Attribute
{
    ...
    ///     load settings once, and then save them whenever necessary to whichever path is returned by this function.</summary>
    /// <remarks>
    ///     This method checks if a file by the name <c>(AppName).IsPortable.txt</c> exists in the application path. If that
    ///     file exists, the settings are always stored in that application path. This check is skipped if there is no entry
    ///     assembly (<see cref="Assembly.GetEntryAssembly"/> is null).</remarks>
