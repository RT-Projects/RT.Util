...
{
    /// <summary>
    ///     Generates a plasma fractal of the specified size.</summary>
    /// <param name="width">
    ///     Width of the bitmap to generate.</param>
    /// <param name="height">
    ///     Height of the bitmap to generate.</param>
    /// <param name="leftTop">
    ///     Desired color of the top-left pixel.</param>
    /// <param name="rightTop">
    ///     Desired color of the top-right pixel.</param>
    /// <param name="leftBottom">
    ///     Desired color of the bottom-left pixel.</param>
    /// <param name="rightBottom">
    ///     Desired color of the bottom-right pixel.</param>
    /// <param name="varyRLevel">
    ///     A number between 0 and 8 specifying by how much to vary the Red channel. 0 means maximum variance, 8 means no
    ///     variance.</param>
    /// <param name="varyGLevel">
    ///     A number between 0 and 8 specifying by how much to vary the Green channel. 0 means maximum variance, 8 means no
    ///     variance.</param>
    /// <param name="varyBLevel">
    ///     A number between 0 and 8 specifying by how much to vary the Blue channel. 0 means maximum variance, 8 means no
    ///     variance.</param>
    /// <returns>
    ///     The generated plasma fractal as a Bitmap object.</returns>
