...
///             literal square bracket. In other words, <c>[ xyz]</c> is equivalent to <c>[(]xyz[)]</c>.</description></item></list></remarks>
public static class CuteML
{
    ...
    ///             consolidated, so there are no two consecutive <see cref="CuteText"/> instances in any list of children.</description></item></list></remarks>
    /// <exception cref="CuteMLParseException">
    ///     Invalid syntax was encountered. The exception object contains the string index at which the error was detected.</exception>
...
public abstract class CuteNode
{
    ...
    ///     <list type="bullet">
    ///         <item><description>
    ///             <c>[&lt;color&gt;:...]</c> = use the specified console color, for example <c>[&lt;darkred&gt;:...]</c>.</description></item>
    ///         <item><description>
