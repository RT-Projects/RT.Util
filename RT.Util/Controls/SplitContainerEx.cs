...
{
    /// <summary>Initialises a <see cref="SplitContainerEx"/> instance.</summary>
    ...
    /// <summary>Specifies whether the splitter should be painted.</summary>
    ...
    /// <summary>
    ///     Stores a reference to the specified settings class, or null to disable the saving of settings. Loads the settings
    ///     from the specified instance and applies them to the control. Must be called in form's Load event or later to have
    ///     an effect!</summary>
