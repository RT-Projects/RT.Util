...
/// <summary>
///     Number system with a string for 1 and another for all other numbers (e.g. Danish, Dutch, English, Faroese, German,
///     Norwegian, Swedish, Estonian, Finnish, Greek, Hebrew, Italian, Portuguese, Spanish, Esperanto).</summary>
...
/// <summary>
///     Number system for Latvian: one string for numbers ending in 1 but not 11; one for everything else but 0; and one for
///     0.</summary>
...
/// <summary>
///     Number system for Irish: one string for numbers ending in 1-6, one for numbers ending in 7-9, one for numbers ending
///     in 0.</summary>
...
/// <summary>
///     Number system for Romanian: one string for 1; one for 0 and for all numbers ending in something between 01 and 19; and
///     one for all other numbers.</summary>
...
/// <summary>
///     Number system for Lithuanian: one string for numbers ending in 1 but not 11; one for numbers ending in 2-9 but not
///     12-19; and one for all other numbers.</summary>
...
/// <summary>
///     One string for numbers ending in 1 but not 11; one for numbers ending in 2-4 but not 12-14; and one for all other
///     numbers (e.g. Croatian, Serbian, Russian, Ukrainian).</summary>
...
/// <summary>
///     Number system for Polish: one string for 1; one for numbers ending in 2-4 but not 12-14; and one for all other
///     numbers.</summary>
