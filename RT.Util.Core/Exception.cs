...
/// <summary>
///     Represents an internal error in the code. Any place where the code is able to verify its own consistency is where this
///     exception should be thrown, for example in "unreachable" code safeguards.</summary>
