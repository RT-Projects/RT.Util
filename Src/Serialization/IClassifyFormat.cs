...
namespace RT.Util.Serialization
{
    ...
    public interface IClassifyFormat<TElement>
    {
        ...
        bool HasField(TElement element, string fieldName, string declaringType, StringComparison comparisonMode);
        ...
        TElement GetField(TElement element, string fieldName, string declaringType, StringComparison comparisonMode);
