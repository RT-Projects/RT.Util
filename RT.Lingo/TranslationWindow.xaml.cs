...
/// <summary>Interaction logic for TranslationWindow.xaml</summary>
public partial class TranslationWindow : ManagedWindow, ITranslationDialog
{
    ...
    ///     The type containing the <see cref="TrString"/> and <see cref="TrStringNum"/> fields to be translated.</param>
    /// <param name="settings">
    ///     Settings of the <see cref="TranslationWindow"/>.</param>
    /// <param name="icon">
