...
/// <summary>
///     Used for functions which change the language of the program.</summary>
/// <typeparam name="TTranslation">
///     The type of the translation class.</typeparam>
/// <param name="translation">
///     The new translation to be used by the program.</param>
public delegate void SetTranslation<in TTranslation>(TTranslation translation) where TTranslation : TranslationBase;

/// <summary>Static class with helper methods to support multi-language applications.</summary>
public static partial class Lingo
{
    /// <summary>
    ///     If not null, whenever a translation is saved, Lingo will also attempt to save it in this directory. Use an
    ///     absolute path. Lingo will quietly ignore any errors when saving here, and will do nothing if the path is missing.
    ///     Lingo will overwrite read-only files without prompts.</summary>
    public static string AlsoSaveTranslationsTo = null;

    /// <summary>
    ///     Attempts to load the translation for the specified module and language. The translation must exist in the
    ///     application executable directory under a subdirectory called "Translations". If the translation loaded
    ///     successfully, returns the translation instance. Otherwise, the <typeparamref name="TTranslation"/> default
    ///     constructor is called and the result returned, and <paramref name="language"/> is set to the default language
    ///     returned by this constructor.</summary>
    /// <typeparam name="TTranslation">
    ///     The type of the translation class to load the translation into.</typeparam>
    /// <param name="module">
    ///     The name of the module whose translation to load.</param>
    /// <param name="language">
    ///     The language code of the language to load. This is set to the default language if the specified language cannot be
    ///     loaded.</param>
    /// <returns>
    ///     The loaded or default translation.</returns>
    ...
    /// <summary>
    ///     Loads and returns the translation for the specified module and language. The translation must exist in the
    ///     application executable directory under a subdirectory called "Translations". If the translation cannot be loaded
    ///     successfully, an exception is thrown.</summary>
    /// <typeparam name="TTranslation">
    ///     The type of the translation class to load the translation into.</typeparam>
    /// <param name="module">
    ///     The name of the module whose translation to load.</param>
    /// <param name="language">
    ///     The language code of the language to load.</param>
    /// <returns>
    ///     The loaded translation.</returns>
    ...
    ///     The type of the translation class to load the translation into.</param>
    /// <param name="module">
    ///     The name of the module whose translation to load.</param>
    /// <param name="language">
    ///     The language code of the language to load.</param>
    ...
    /// <summary>
    ///     Writes the specified translation for the specified module to an XML file in the application directory.</summary>
    /// <typeparam name="TTranslation">
    ///     Translation class to write.</typeparam>
    /// <param name="moduleName">
    ///     Name of the module for which this is a translation.</param>
    /// <param name="translation">
    ///     The translation to save.</param>
    ...
    ///     Writes the specified translation for the specified module to an XML file in the application directory.</summary>
    /// <param name="translationType">
    ///     Translation class to write.</param>
    /// <param name="moduleName">
    ///     Name of the module for which this is a translation.</param>
    /// <param name="translation">
    ///     The translation to save.</param>
    ...
    /// <summary>
    ///     Returns the language from the <see cref="Language"/> enum which corresponds to the specified ISO code, or null if
    ...
    /// <summary>
    ///     Contains utility methods to generate C# code for translation strings required for automated translation of forms
    ///     and controls.</summary>
    public sealed partial class TranslationFileGenerator : IDisposable
    {
        ...
        ///     Constructor.</summary>
        /// <param name="filename">
        ///     Path and filename where to store the auto-generated code.</param>
        ...
        ///     while simultaneously generating C# code for the required translation strings.</summary>
        /// <param name="control">
        ///     Control whose text is to be translated.</param>
        /// <param name="translation">
        ///     Object containing the translations.</param>
        ...
        /// <summary>
        ///     Translates the text of the specified WPF window and all its sub-controls using the specified translation
        ///     object, while simultaneously generating C# code for the required translation strings.</summary>
        /// <param name="window">
        ///     Window whose controls are to be translated.</param>
        /// <param name="translation">
        ///     Object containing the translations.</param>
    ...
    /// <summary>
    ///     Translates the text of the specified control and all its sub-controls using the specified translation object.</summary>
    /// <param name="control">
    ///     Control whose text is to be translated.</param>
    /// <param name="translation">
    ///     Object containing the translations.</param>
    ...
    /// <summary>
    ///     Checks the specified assemblies for any obvious Lingo-related problems, including unused strings, mismatched enum
    ///     translations.</summary>
    /// <typeparam name="TTranslation">
    ///     The type of the translation class.</typeparam>
    /// <param name="rep">
    ///     Post-build step reporter.</param>
    /// <param name="assemblies">
    ///     A list of assemblies to check. The Lingo assembly is included automatically to ensure correct operation.</param>
    ...
    /// <summary>
    ///     Checks that the enum values declared in the specified enum type and the TrString fields declared in the specified
    ///     translation type match exactly.</summary>
