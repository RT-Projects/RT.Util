...
namespace RT.Util.Serialization
{
    ...
    public static class ClassifyJson
    {
        ...
        public static T DeserializeFile<T>(string filename, ClassifyOptions options = null, IClassifyFormat<JsonValue> format = null, object parent = null)
        {
            return Classify.DeserializeFile<JsonValue, T>(filename, format ?? DefaultFormat, options, parent);
        }
