...
/// <summary>
///     Provides a ListBox with added functionality. See remarks.</summary>
/// <remarks>
///     <para>
///         The extra methods <see cref="RefreshItem"/> and <see cref="RefreshItems"/> just call base methods which are
///         inexplicably protected.</para>
///     <para>
///         When setting <c>SelectionMode</c> to <c>SelectionMode.MultiExtended</c>, this listbox supports Ctrl+Arrow keys and
///         Ctrl+Space properly, unlike the standard ListBox where these don’t work.</para></remarks>
public class ListBoxEx : ListBox
{
    ...
    /// <summary>
    ///     Refreshes the item contained at the specified index.</summary>
    /// <param name="index">
    ///     The zero-based index of the element to refresh.</param>
    ...
    /// <summary>
    ///     Gets or sets the zero-based index of the list item that has the dotted outline.</summary>
    /// <remarks>
    ///     <para>
    ///         The list item may be selected or not.</para>
    ///     <para>
    ///         Changing this property does not fire a SelectedIndexChanged event.</para></remarks>
    [DefaultValue(0)]
