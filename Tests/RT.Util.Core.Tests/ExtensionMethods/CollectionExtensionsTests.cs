...
public sealed class CollectionExtensionsTests
{
    ...
    {
        Assert.Throws<ArgumentNullException>(() => { RngExtensions.Shuffle<List<string>>(null); });
