...
namespace RT.KitchenSink
{
    ...
    ///             reading from the closed channel throws. The <see cref="TryRead"/> method can be used to avoid this
    ///             exception. Note that accessing <see cref="HasMore"/> is not enough as another reading thread can dequeue
