...
{
    public delegate TResult FuncNullable<in TInput, TResult>(TInput input) where TResult : struct;
    ...
    public static class ObjectExtensions
    {
        ...
        public static TResult NullOr<TInput, TResult>(this TInput input, Func<TInput, TResult> lambda) where TResult : class
        {
