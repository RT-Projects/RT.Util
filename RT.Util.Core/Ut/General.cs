...
static partial class Ut
{
    ...
    /// <summary>
    ///     Converts the bytes at the specified <paramref name="index"/> within the specified <paramref name="buffer"/> to a
    ///     16-bit unsigned integer.</summary>
    /// <param name="buffer">
    ...
    /// <summary>
    ///     Converts the bytes at the specified <paramref name="index"/> within the specified <paramref name="buffer"/> to a
    ///     32-bit unsigned integer.</summary>
    /// <param name="buffer">
    ///     Array to take values from.</param>
    /// <param name="index">
    ///     Index within the array at which to start taking values.</param>
    ...
    /// <summary>
    ///     Converts the bytes at the specified <paramref name="index"/> within the specified <paramref name="buffer"/> to a
    ///     64-bit unsigned integer.</summary>
    /// <param name="buffer">
    ///     Array to take values from.</param>
    /// <param name="index">
    ///     Index within the array at which to start taking values.</param>
    ...
    /// <param name="step">
    ///     The difference between the values to generate, except that the difference between the last and second-last may be
    ///     smaller if the interval between <paramref name="start"/> and <paramref name="end"/> isn’t exactly divisible by
    ///     <paramref name="step"/>.</param>
