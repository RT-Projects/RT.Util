...
///     intended to be grouped using a <see cref="MenuRadioGroup&lt;T&gt;"/>.</summary>
/// <typeparam name="T">
///     The type of the value associated with this menu item.</typeparam>
public class MenuRadioItem<T> : ToolStripMenuItem where T : struct
{
    ...
    /// <summary>Returns the group to which this menu item belongs, or moves it to a different group.</summary>
