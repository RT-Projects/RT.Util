...
static class CustomCallStack
{
    ...
    ///         always return a <see cref="WorkStep{T}.Call"/>, they will consume memory rampantly and never finish.</para></remarks>
...
/// <returns>
///     The next step of computation (which is either a <see cref="WorkStep{T}.Return"/> or a <see cref="WorkStep{T}.Call"/>).</returns>
#if EXPORT_UTIL
public
#endif
