...
partial class Ut
{
    ...
    /// <summary>
    ///     Runs the specified function in parallel for each item in the input collection and returns a collection containing
    ///     the concatenation of all the results of the function calls.</summary>
    ...
    /// <summary>
    ///     Runs the specified function in parallel for each item in the input collection and returns a collection containing
    ///     the results of the function calls.</summary>
    /// <typeparam name="TSource">
    ///     The type of the elements of <paramref name="items"/>.</typeparam>
    /// <typeparam name="TResult">
